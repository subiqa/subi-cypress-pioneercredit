...
import Homepage from '../../../integration/pageObjectsPioneerCredit/Homepage'

describe('Homepage - Desktop', function() 
{
    before(function () {
        cy.fixture('PioneerCredit/pioneercredithomepage').then(function (data) {
          this.data = data;
        })
    ...
    it('Block 1: Hero Banner content is correct',function() {
    ...
    it('Block 2: Image Lift Out content is correct',function() {
        const homepage = new Homepage()
        //Image is correct
    ...
    it('Block 3: Heading content is correct',function() {
        const homepage = new Homepage()
        //H2 text is correct
    ...
    it('Block 4: Accordion content is correct',function() {
        const homepage = new Homepage()
        //Accordion item 1 
    ...
    it('Block 5: Image Lift Out content is correct',function() {
        const homepage = new Homepage()
        //Image Lift Out 2
        //Image is correct
    ...
    it('Block 6: Heading content is correct',function() {
        const homepage = new Homepage()  
        //Image Card
    ...
    it('Block 7: Cards content is correct',function() {
        const homepage = new Homepage()
        //Card 1 
        //Image is is correct
        homepage.getHomepageBlock4()
    ...
    it('Block 8: Image Lift Out content is correct',function() {
        const homepage = new Homepage()
        //Image Lift Out 3
        //Image is correct
        homepage.getHomepageBlock4()
    ...
    it('Block 9: Featured CTA content is correct',function() {
        const homepage = new Homepage()
        //Featured CTA
        //Heading is correct
...
describe('Homepage - Mobile', function() 
{
    before(function () {
        cy.fixture('PioneerCredit/pioneercredithomepage').then(function (data) {
          this.data = data;
